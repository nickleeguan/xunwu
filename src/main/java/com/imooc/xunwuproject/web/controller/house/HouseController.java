package com.imooc.xunwuproject.web.controller.house;
...
import com.imooc.xunwuproject.service.search.HouseBucketDTO;
...
public class HouseController {
    ...
    public String show(@PathVariable(value = "id") Long houseId, Model model){
        ...
        ServiceResult<Long> result = searchService.aggregateDistrictHouse(city.getEnName(),
    ...
    public String rentMapPage(@RequestParam(value = "cityEnName") String cityEnName,
        ...
        ServiceMultiResult<HouseBucketDTO> result = searchService.mapAggregate(cityEnName);
    ...
    public ApiResponse rentMapHouses(@ModelAttribute MapSearch mapSearch){
        ...
        response.setMore(serviceMultiResult.getTotal() > (mapSearch.getSize() + mapSearch.getStart()));
